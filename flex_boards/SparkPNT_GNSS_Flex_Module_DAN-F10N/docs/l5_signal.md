...
<figcaption markdown>Table 3: UBX binary string to override GPS `L5` signal health status with GPS L1 health status</figcaption>
</figure>
...
<figcaption markdown>Table 4: UBX binary strings to revert the GPS `L5` signal health status monitoring to default</figcaption>
</figure>
